...
y is the result of applying the Disontinuous Integrand function on
...
for i, j in zip(xvalues, range(0, len(xvalues))):
    yvalues[j] = discontinuous(i, [0.5, 0.5], [1, 1])
...
fig.savefig("../../_static/images/fig-discontinuous-integrand")
