"""Figure of the Corner Peak Integrand function in 3D.

x1 is evaluated on [0, 1]
x2 is evaluated on [0, 1]
y is the result of applying the Corner Peak Integrand function on
each combination of x1 and x2 and a1,a2 = 0.5
...
fig.savefig("../../_static/images/fig-corner-peak")
