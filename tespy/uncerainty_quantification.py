...
def borehole(x):
    ...
    T_u = np.uniform(63070, 115600)
    H_u = np.uniform(990, 1110)
    T_l = np.uniform(63.1, 116)
    H_l = np.uniform(700, 820)
    L = np.uniform(1120, 1680)
    K_w = np.uniform(9855, 12045)
...
def ishigami(x_1, y, z, a=7, b=0.1):
